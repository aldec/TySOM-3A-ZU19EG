proc getPresetInfo {} {
  return [dict create name {TySOM-3A-ZU19EG_preset} description {TySOM-3A-ZU19EG_preset}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.2 display_name {TySOM-3A-ZU19EG_preset} ]
}
